...
# TODO: switch to wine versions and extract FEX dlls other way
TERMUX_PKG_VERSION="10.6.1"
_REAL_VERSION="${TERMUX_PKG_VERSION/\~/-}"
# TODO: use REAL_VERSION here
TERMUX_PKG_SRCURL=(
	https://dl.winehq.org/wine/source/10.x/wine-10.7.tar.xz
...
TERMUX_PKG_SHA256=(
	751367a3109990d703e590e2db530187c4e1dfd2e8e61373ab84b42fe11b18fa
